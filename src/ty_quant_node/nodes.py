    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "query_start": ("STRING", {"default": "2024-01-01", "tooltip": "Tushare 日线查询开始日期，包含当天。"}),
                "query_end": ("STRING", {"default": "2024-12-31", "tooltip": "Tushare 日线查询结束日期，包含当天。"}),
                ...
                "train_start": ("STRING", {"default": "", "tooltip": "训练区间开始日期；与训练结束日期一起填写。"}),
                "train_end": ("STRING", {"default": "", "tooltip": "训练区间结束日期；必须早于测试区间开始日期。"}),
                "test_start": ("STRING", {"default": "", "tooltip": "测试区间开始日期；与测试结束日期一起填写。"}),
                "test_end": ("STRING", {"default": "", "tooltip": "测试区间结束日期。"}),
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "query_start": ("STRING", {"default": "2024-01-01", "tooltip": "日线查询开始日期。"}),
                "query_end": ("STRING", {"default": "2024-12-31", "tooltip": "日线查询结束日期。"}),
